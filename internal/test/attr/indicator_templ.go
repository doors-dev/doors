...
func (f *indicatorFragment) button(id string, indicator []doors.Indicator) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `doors/internal/test/attr/indicator.templ`, Line: 129, Col: 16}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `doors/internal/test/attr/indicator.templ`, Line: 129, Col: 65}
		}
