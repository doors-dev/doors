...
//line components.gox:25
						__e = __c.Set("name", "description"); if __e != nil { return }
//line components.gox:25
						__e = __c.Set("content", "Page for parameter: " + ctx.Value(0).(test.Path).P); if __e != nil { return }
					}
					__e = __c.Submit(); if __e != nil { return }
					__e = __c.InitVoid("meta"); if __e != nil { return }
					{
//line components.gox:26
						__e = __c.Set("name", "keywords"); if __e != nil { return }
//line components.gox:26
						__e = __c.Set("content", "param, " + ctx.Value(0).(test.Path).P); if __e != nil { return }
					}
					__e = __c.Submit(); if __e != nil { return }
					__e = __c.InitVoid("meta"); if __e != nil { return }
					{
